name = "luka"
#name არის ცვლადი
# = არის ცვლადისთვის მნიშვნელობუის მიმნიჭებელი სიმბოლო
# "luka" არის ცვლადისთვის მნისჰვნელობა
...
age = 13 # ეს არის int ( integer ) მტელი რიცხვი
height = 170 #ეს არის float ტიპის ცვლადი ( ათწილადი )
#boolean (bool) ტიპის ცვლადი

knows_programming = True #True ან False
is_ugly = False    #snakecase(უბრალოდ წერის სტილი სტანდარტულად)

isUgly = False #ჯავასკრიფტული cameLcase
